...
from app.mongo import get_article
...
def generate_news(article):
    ...
    prompt = (
        ...
        f"Твій стиль: дружній, фанатський, іноді тролінгово-іронічний.\n"
        f"Ти ЗАВЖДИ пишеш пости довжиною до 1024 символів з пробілами. Якщо текст виходить за цей діапазон — ти ОБОВ’ЯЗКОВО обрізаєш або розширюєш його, щоб результат був у межах 1024 символів."        
        f"Особливості стилю:\n"
